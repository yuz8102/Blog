...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateClientsAsync()
    {
        ...
        {
            var blazorServerTieredClientRootUrl = configurationSection["Blog_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');

            /* Blog_BlazorServerTiered client is only needed if you created a tiered blazor server
            ...
            await CreateClientAsync(
                ...
                scopes: commonScopes,
                grantTypes: new[] { "hybrid" },
                secret: (configurationSection["Blog_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*").Sha256(),
